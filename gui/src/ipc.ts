...
export const ipc = {
  ...
  add(name: string, localRoot: string, remoteBase: string, folders?: string[], syncHiddenFiles?: boolean, autoSyncOnChange?: boolean, onDemand?: boolean): Promise<void> {
    return invoke("ipc_add", { name, localRoot, remoteBase, folders: folders ?? null, syncHiddenFiles: syncHiddenFiles ?? null, autoSyncOnChange: autoSyncOnChange ?? null, onDemand: onDemand ?? null });
  },
  ...
  update(name: string, localRoot: string, remoteBase: string, folders?: string[], syncHiddenFiles?: boolean, autoSyncOnChange?: boolean, onDemand?: boolean): Promise<void> {
    return invoke("ipc_update", { name, localRoot, remoteBase, folders: folders ?? null, syncHiddenFiles: syncHiddenFiles ?? null, autoSyncOnChange: autoSyncOnChange ?? null, onDemand: onDemand ?? null });
  },
